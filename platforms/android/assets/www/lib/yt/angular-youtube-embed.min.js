angular.module("youtube-embed", ["ng"]).service("youtubeEmbedUtils", ["$window", "$rootScope", function(e, t) {
    ...
    var n = {},
        i = /https?:\/\/(?:[0-9A-Z-]+\.)?(?:youtu\.be\/|youtube(?:-nocookie)?\.com\S*[^\w\s-])([\w-]{11})(?=[^\w-]|$)(?![?=&+%\w.-]*(?:['"][^<>]*>|<\/a>))[?=&+%\w.-]*/gi,
        o = /t=(\d+)[ms]?(\d+)?s?/;
    return n.getIdFromURL = function(e) {
        var t = e.replace(i, "$1");
        if (r(t, ";")) {
            var a = t.split(";");
            if (r(a[1], "%")) {
                var n = decodeURIComponent(t.split(";")[1]);
                t = ("http://youtube.com" + n).replace(i, "$1")
            } else t = a[0]
        } else r(t, "#") && (t = t.split("#")[0]);
        return t
    }, n.getTimeFromURL = function(e) {
        e = e || "";
        var t = e.match(o);
        if (!t) return 0;
        var a = t[0],
            n = t[1],
            i = t[2];
        return "undefined" != typeof i ? (i = parseInt(i, 10), n = parseInt(n, 10)) : r(a, "m") ? (n = parseInt(n, 10), i = 0) : (i = parseInt(n, 10), n = 0), i + 60 * n
    }, n.ready = !1, "undefined" == typeof YT ? e.onYouTubeIframeAPIReady = a : YT.loaded ? n.ready = !0 : YT.ready(a), n
    ...
    return {
        ...
        link: function(n, i, o) {
            ...
            function u(e) {
                var t = r[e.data];
                "undefined" != typeof t && d(a + t, n.player, e), n.$apply(function() {
                    n.player.currentState = t
                })
            }

            function l(e) {
                d(a + "ready", n.player, e)
            }

            function y(e) {
                d(a + "error", n.player, e)
            }
            ...
            function f() {
                (n.videoId || n.playerVars.list) && (n.player && "function" == typeof n.player.destroy && n.player.destroy(), n.player = p())
            }
            n.utils = e;
            var c = o.playerId || i[0].id || "unique-youtube-embed-id-" + t++;

	  i[0].setAttribute("sandbox","allow-same-origin allow-scripts");
            ...
            var s = n.$watch(function() {
                ...
                e && (s(), "undefined" != typeof n.videoUrl ? n.$watch("videoUrl", function(e) {
                    n.videoId = n.utils.getIdFromURL(e), n.urlStartTime = n.utils.getTimeFromURL(e), f()
                }) : "undefined" != typeof n.videoId ? n.$watch("videoId", function() {
                    n.urlStartTime = null, f()
